// src/components/charts/AirQualityGauge.tsx
    ...
    <Card className="bg-gradient-to-br from-emerald-50 to-teal-100 dark:from-emerald-900 dark:to-teal-950">
      <CardContent className="p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-sm font-bold text-gray-800 dark:text-gray-100">AIR QUALITY</h3>
          <button className="text-xs text-gray-600 dark:text-gray-400">+</button>
        </div>
          ...
          <div className="relative">
            <svg className="w-32 h-32 transform -rotate-90">
              ...
              <circle
                ...
                strokeWidth="12"
                fill="none"
                strokeDasharray={`${(aqi / 150) * 352} 352`}
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                <Gauge className={`w-8 h-8 ${color} mb-1`} />
                <div className="text-2xl font-bold text-gray-800 dark:text-gray-100">{aqi}</div>
                <div className={`text-xs font-medium ${color}`}>{level}</div>
              </div>
            </div>
          </div>
        </div>
